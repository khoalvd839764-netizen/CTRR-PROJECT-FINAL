...
class App:
    ...
    # =========================================================================
    # CHỨC NĂNG 10: ỨNG DỤNG THỰC TẾ (ROBOT HÚT BỤI THÔNG MINH)
    # =========================================================================
    def handle_practical_robot_app(self):
        self.print_header("🤖 KHỞI CHẠY ỨNG DỤNG THỰC TẾ: ROBOT HÚT BỤI THÔNG MINH")
        print("Đang khởi động Giao diện Đa góc nhìn (3D Isometric Sa bàn + Đồ thị Toán học + Mã giả)...")
        try:
    ...
    def run(self):
        while True:
            ...
            print("   [10] 🤖 ỨNG DỤNG THỰC TẾ: Robot Hút Bụi Thông Minh (Giao diện 3D Sa Bàn + 7 Thuật Toán)")
            ...
            if choice == '1':
                ...
                self.handle_practical_robot_app()
            elif choice == '0':
