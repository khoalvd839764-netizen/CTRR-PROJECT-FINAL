# -*- coding: utf-8 -*-
"""
Module: ung_dung_thuc_te/city_map_data.py
Dữ liệu cấu hình bản đồ sa bàn giao thông UTH & Quận Bình Thạnh:
- CITY_NODES: Danh mục 45 nút giao, trạm cứu hộ, bệnh viện và địa danh.
- CITY_EDGES: Danh mục 72 tuyến đường huyết mạch kèm khoảng cách (m), hướng và tên đường.
Tọa độ được chuẩn hóa cho khung hiển thị 1600x920 / 1280x720.
"""

# Danh mục 45 Đỉnh (Nodes) - Tọa độ chuẩn cho Sa bàn giao thông
CITY_NODES = {
    0: {
...
# Định dạng mỗi phần tử: (u, v, khoảng cách mét, một_chiều_bool, tên_đường)
CITY_EDGES = [
